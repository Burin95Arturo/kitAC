...
#define IR_PIN              GPIO_NUM_1     // Pin IR
#define HX711_DOUT_PIN      GPIO_NUM_36     // Pin de datos (DOUT) del HX711
#define HX711_PD_SCK_PIN    GPIO_NUM_39     // Pin de reloj (PD_SCK) del HX711
#define BUTTON_PESO_PIN     GPIO_NUM_9     // Botón para "Arriba" o "Incrementar"
#define BUTTON_TARA_PIN     GPIO_NUM_25     // Botón para "Abajo" o "Disminuir"
#define BUTTON_ATRAS_PIN    GPIO_NUM_26   // Botón para "Seleccionar" o "Confirmar"
...
//2da balanza 
#define HX711_2_DOUT_PIN    GPIO_NUM_34     // Pin de datos (DOUT) del HX711 de la 2da balanza
#define HX711_2_PD_SCK_PIN  GPIO_NUM_35     // Pin de reloj (PD_SCK) del HX711 de la 2da balanza
