...
//Buttons
#define BUTTON_UP_PIN       GPIO_NUM_36     // Botón para "Arriba" o "Incrementar"
#define BUTTON_DOWN_PIN     GPIO_NUM_34     // Botón para "Abajo" o "Disminuir"
#define BUTTON_SELECT_PIN   GPIO_NUM_27   // Botón para "Seleccionar" o "Confirmar"
#define BUTTON_BACK_PIN     GPIO_NUM_12   // Botón para "Back" o "Cancel"
...
#define I2C_MASTER_SCL_IO   GPIO_NUM_32    // Tu pin SCL (GPIO22)
#define I2C_MASTER_SDA_IO   GPIO_NUM_13    // Tu pin SDA (GPIO21)
