...
#define TRIG_PIN            GPIO_NUM_9      // Pin TRIG del HC-SR04
...
#define IR_PIN              GPIO_NUM_27     // Pin IR
#define HX711_DOUT_PIN      GPIO_NUM_25     // Pin de datos (DOUT) del HX711
#define HX711_PD_SCK_PIN    GPIO_NUM_12     // Pin de reloj (PD_SCK) del HX711
#define BUTTON_1            GPIO_NUM_34     // Botón para "Arriba" o "Incrementar"
#define BUTTON_2            GPIO_NUM_35     // Botón para "Abajo" o "Disminuir"
#define BUTTON_3            GPIO_NUM_36   // Botón para "Seleccionar" o "Confirmar"
#define BUTTON_4            GPIO_NUM_39   // Botón 4
